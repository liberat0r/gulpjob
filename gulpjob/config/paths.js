...
var files = {
	...
	src: {
		...
		compiled_js     : ['!' + basePaths.dist + 'js/*.min*', basePaths.dist + 'js/*'], // does not minify files that reside in folders
		js              : [basePaths.main + 'js/**/*.js', '!' + basePaths.main + 'js/**/_*'],
		js_hint         : basePaths.main + 'js/*.js', // only hints files that are not in folders
		scss            : [basePaths.main + 'scss/**/*.scss', '!' + basePaths.main + 'scss/generate_sprites.scss', '!' + basePaths.main + 'scss/**/_*'],
		compiled_scss   : ['!' + basePaths.dist + 'css/*.min*', basePaths.dist + 'css/*'], // does not minify files that reside in folders
